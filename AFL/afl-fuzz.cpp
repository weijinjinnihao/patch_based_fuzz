...
EXP_ST u8 *in_dir,                    /* Input directory with test cases  */
          ...
          *target_path2,              //____________________________________?sqlright里没有
...
static s32 out_fd,                    /* Persistent fd for out_file       */
          //新增
           ...
           fsrv_ctl_fd2,              //__________________________________?
           fsrv_st_fd2;
...
EXP_ST void setup_shm(void) {
  ...
  shm_id = shmget(IPC_PRIVATE, MAP_SIZE + 16 + targets_num, IPC_CREAT | IPC_EXCL | 0640);
...
EXP_ST void check_binary2(u8* fname) {
  ...
  if ((!strncmp(target_path2, "/tmp/", 5) && !strchr((char*)target_path2 + 5, '/')) ||
      (!strncmp(target_path2, "/var/tmp/", 9) && !strchr((char*)target_path2 + 9, '/')))
     FATAL("Please don't keep binaries in /tmp or /var/tmp");
